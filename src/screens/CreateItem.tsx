...
const CreateItem = () => {
  ...
  const handleCreateItem = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/create_item/${partnerId}`, {
        method: "POST",
      ...
      if (response.status === 201) {
        ...
        Alert.alert("Erro", data.error || "Falha ao criar o item.");
      }
    } catch (error) {
  ...
  const uploadImage = async () => {
    ...
    try {
      const response = await fetch(`${backendUrl}/foto_store`, {
        method: "POST",
  ...
  return (
    <View style={CreateItemStyles.container}>
        ...
        <View style={CreateItemStyles.main}>
          <View style={CreateItemStyles.postsContainer}>
            ...
            <TouchableOpacity
              ...
              style={CreateItemStyles.imageContainer}
            >
              {selectedImage ? (
                ...
                <View style={CreateItemStyles.photosContainer}>
                  ...
                  <Text style={CreateItemStyles.camText}>
                    Resolução 400X350
                  </Text>
                </View>
              )}
            ...
            />
            <TouchableOpacity
              style={CreateItemStyles.createBtn}
      ...
      />
      <View style={CreateItemStyles.footer}>
        <Footer />
      </View>
    </View>
  );
