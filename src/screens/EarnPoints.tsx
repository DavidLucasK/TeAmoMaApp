          ...
          <View style={EarnPointsStyles.games}>
            <View style={EarnPointsStyles.card}>
              <TouchableOpacity
                ...
                style={EarnPointsStyles.imagesGames}
              >
                <Image
              ...
              <Text style={EarnPointsStyles.cardText}>
                Responda perguntas e ganhe LovePoints!
              </Text>
              <TouchableOpacity
            ...
            <TouchableOpacity>
              <View
                style={[EarnPointsStyles.card, EarnPointsStyles.disabledCard]}
              >
