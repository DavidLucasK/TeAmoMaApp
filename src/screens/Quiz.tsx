...
const Quiz: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchQuestions = async () => {
      try {
        const response = await fetch(`${backendUrl}/questions/${user}`, {
          method: "GET",
          headers: {
      ...
      <View style={QuizStyles.quizContainer}>
        ...
        >
          <View style={QuizStyles.card}>
            <ActivityIndicator size="large" color="#e41d69" />
          </View>
        </LinearGradient>
      </View>
    );
  ...
  if (quizStatus) {
    return (
      <View style={QuizStyles.quizContainer}>
        ...
        >
          <View style={QuizStyles.card}>
            <Text style={QuizStyles.titleBack}>
              Você já completou o quiz hoje!
            </Text>
            <Text style={QuizStyles.titleBack}>Volte amanhã ❤️</Text>
            <TouchableOpacity
              style={QuizStyles.btnBack}
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      isAnswered && !answer.is_correta
                        ? QuizStyles.incorrect
                        : {}, // Se foi respondida e incorreta, aplica o estilo incorreto
                    ]}
              ...
              <TouchableOpacity
                style={[
                  ...
                  currentQuestionIndex === questions.length - 1
                    ...
                    : {}, // Aplica estilo de desabilitado se for a última pergunta
                ]}
                onPress={() => {
                  if (currentQuestionIndex === questions.length - 1) {
