...
const CreatePost: React.FC = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      const response = await fetch(`${backendUrl}/foto_post`, {
        method: "POST",
  ...
  const createPost = async () => {
    ...
    if (imagePath) {
      try {
        await fetch(`${backendUrl}/upload_post`, {
          method: "POST",
        ...
        Alert.alert(
          "Erro",
          "Não foi possível criar o post no momento. Tente mais tarde."
        );
      }
    }
    setUploading(false);
  ...
  return (
    ...
    >
        ...
        >
          <View style={CreatePostStyles.main}>
            <View style={CreatePostStyles.postsContainer}>
              <View style={CreatePostStyles.imageContainer}>
                ...
                <View style={CreatePostStyles.photosContainer}>
                  <TouchableOpacity
                    ...
                    style={CreatePostStyles.camContainer}
                  >
                    <Image
              ...
              <TouchableOpacity
                onPress={createPost}
                style={CreatePostStyles.createBtn}
                disabled={uploading}
              >
                {uploading ? (
                  <View>
        ...
        >
          <View style={CreatePostStyles.modalContainer}>
            <View style={CreatePostStyles.modalContent}>
              <Text
                style={CreatePostStyles.modalText}
      ...
      <View style={CreatePostStyles.footer}>
        <Footer />
      </View>
    </KeyboardAvoidingView>
  );
